...
VALUES 
(1, now(), 'sys', null, 'eric.sanjaya@icloud.com', 'Eric', false, 'Sanjaya', now(), 'sys', '$2a$10$x7D7ZrUozIdeUvYT9./Vf.q.Vzqr4mEN7869O1wwqzBUdOn7JRQUu', '87860408682', '+62', 'ericsanjaya', 'ACTIVE');


INSERT INTO `teamsync`.`users_roles`
...
INSERT INTO `teamsync`.`personal_workspace_plan_subscriptions`
...
INSERT INTO `teamsync`.`personal_workspace_projects` 
...
INSERT INTO
`teamsync`.`personal_workspace_tasks` (`id`, `created_by`, `created_date`, `is_deleted`, `last_modified_by`, `last_modified_date`, `status`, `description`, `is_flagged`, `last_operation`, `name`, `source`, `personal_workspace_id`, `personal_workspace_project_id`, `user_id`)
VALUES
